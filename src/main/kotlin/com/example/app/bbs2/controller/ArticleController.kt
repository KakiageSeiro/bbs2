package com.example.app.bbs2.controller

import com.example.app.bbs2.domain.entity.Article
import com.example.app.bbs2.domain.repository.ArticleRepository
import com.example.app.bbs2.request.ArticleRequest
...
class ArticleController {
    ...
    fun updateArticle(articleRequest: ArticleRequest) : String {
        ...
        //キーが間違っている場合は編集画面に戻す
        val article: Article =
                articleRepository.findById(articleRequest.id).get()
